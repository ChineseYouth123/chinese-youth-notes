...
export const themeConfig = {
  ...
  siteMeta: {
    ...
    lang: "zh-CN",
    // 反馈表单地址（集中管理）
    feedbackUrl: "https://flat-gargoyle-89e.notion.site/ebd//362eedabc59c805eb40deb3160502512",
    // 作者
    author: {
      name: "中国青年",
  ...
  nav: [
    ...
    },
    {
      text: "图书馆",
      items: [
        { text: "图书首页", link: "/pages/library", icon: "home" },
        { text: "毛泽东", link: "/pages/library/maozedong", icon: "account" },
        { text: "红色书籍", link: "/pages/library/red-books", icon: "fire" },
    ...
    //   text: "友链",
    //   items: [
    //     { text: "友链朋友", link: "/pages/friends", icon: "fish" },
  ...
  navMore: [
    ...
    },
    {
      ...
      list: [
        {
          icon: "https://lf-douyin-msite.douyin.com/obj/eden-cn/t_ojyhlz_upfbvk/ljhwZthlaukjlkulzlp/assets/ios_favicon_logo.png",
          name: "今日热榜",
          url: "https://www.baidu.com/link?url=sQApK3GQv7BcPyUG6FwCWMkzJF0biZolg4ADFOxhUWQUXG7ORQgcr-k_MRWosU4FTNzSc967P_jdCqJnPqk3ya&wd=&eqid=f28b251d00f5e925000000066a08615f",
        },
        {
          icon: "https://cdn.deepseek.com/images/deepseek-chat-open-graph-image.jpeg",
          name: "deepseek",
