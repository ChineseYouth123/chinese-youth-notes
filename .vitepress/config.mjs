...
import { getCategoriesFiles } from "./theme/utils/getCategoriesFiles.mjs";
...
const categoriesFilesData = await getCategoriesFiles();
...
export default withPwa(
  defineConfig({
    ...
    themeConfig: {
      ...
      categoriesFilesData: categoriesFilesData,
    },
    // markdown
    markdown: {
      math: true,
